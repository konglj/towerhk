...
public class WeiXinApi {
	...
	//public static final String appid = "wxbeb3eddd1b9336ed";
	//public static final String secret = "dcf23daa180179ade87ecbf043ad7e0e";
	public static Map getOpenidInfo(String code) {
		Map map = null;
		String openid = "";

		String url = String.format(openidUrl, WXInfo.appid, WXInfo.secret, code);
		String result = "";
		try {
	...
	public static Map getUserInfo(String token,String openid){
		Map map=null;
		String url = String.format(userInfoUrl, token, WXInfo.appid);
		String result = "";
		try {
			result = HttpRequst.sendGet(url);

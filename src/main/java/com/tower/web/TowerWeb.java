		...
		try {
			if (tower.getTowerj() != null && !tower.getTowerj().equals("")
				...
				if(tower.getTowerfirstj()!=null&&!tower.getTowerfirstj().equals("")&&tower.getTowerfirstw()!=null&&!tower.getTowerfirstw().equals("")){
					point = GPSUtil
							.GpsToBaidu(tower.getTowerfirstw(), tower.getTowerfirstj());
					if (point != null) {
						tower.setTowerfirstjbaidu(String.valueOf(point.getLng()));
						tower.setTowerfirstwbaidu(String.valueOf(point.getLat()));
					}else{
				...
				if(tower.getTowersecondj()!=null&&!tower.getTowersecondj().equals("")&&tower.getTowersecondw()!=null&&!tower.getTowersecondw().equals("")){
					point = GPSUtil
							.GpsToBaidu(tower.getTowersecondw(), tower.getTowersecondj());
					if (point != null) {
						tower.setTowersecondjbaidu(String.valueOf(point.getLng()));
						tower.setTowersecondwbaidu(String.valueOf(point.getLat()));
					}else{
